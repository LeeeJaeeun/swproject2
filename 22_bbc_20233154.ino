...
#define _DUTY_MAX 4000 // 2000
#define _DUTY_NEU 2070 // 1500
#define _DUTY_MIN 100 // 1000

#define _SERVO_ANGLE_DIFF  251  // Replace with |D - E| degree
...
float volt_to_distance(int a_value)
{
  ...
  return 469 + -1.55 * a_value + 1.32E-03 * a_value * a_value;
}
